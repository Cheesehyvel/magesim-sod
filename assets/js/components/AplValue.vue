        ...
        computed: {
            ...
            buffOptions() {
                var options = [
                    ...
                    { value: constants.buffs.ECHOES_OF_MADNESS, title: "Fractured Mind Pauldrons", config: "item_fractured_mind_pauldrons" },
                    ...
                    { value: constants.buffs.ECHOES_OF_INSANITY, title: "Mantle of Insanity", config: "item_mantle_insanity" },
                    ...
                    { value: constants.buffs.ECHOES_OF_DEPRAVED, title: "Shoulderpads of the Deranged", config: "item_shoulderpads_deranged" },
                    ...
                    { value: constants.buffs.UNRESTRAINED_POWER, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.BLUE_DRAGON, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.BURST_OF_KNOWLEDGE, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.CHROMATIC_INFUSION, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.OBSIDIAN_INSIGHT, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.CHAOS_FIRE, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.ARCANE_POTENCY, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.MQG, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.NAT_PAGLE, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.ESSENCE_OF_SAPPHIRON, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.EPHEMERAL_POWER, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                    { value: constants.buffs.UNSTABLE_POWER, title: "Trinket: "+this.itemTitle("trinket", ), trinket: items.ids.TRINKET_ },
                ];
